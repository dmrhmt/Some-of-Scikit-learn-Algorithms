...
dtc = DecisionTreeClassifier(criterion="entropy") #criterion="gini" de olabilir(default gini)
...
rfc = RandomForestClassifier(n_estimators=10, criterion="entropy") # gini criterion da var
